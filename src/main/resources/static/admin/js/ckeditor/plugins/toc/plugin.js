...
//output toc
						var tocNode = '<div name="tableOfContents" id="main-toc"><p class="toc_title"><b>' + editor.lang.toc.ToC +'</b></p>'+'<div name="tableOfContents" class="main-toclist">' + tocItems + '</div></div>';
